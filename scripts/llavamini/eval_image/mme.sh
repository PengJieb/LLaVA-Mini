...
python calculation.py --results_dir answers/$CKPT #> $LLAVA_MINI_ROOT/playground/data/eval/MME/answers/$CKPT/res_alldata.txt

#cat $LLAVA_MINI_ROOT/playground/data/eval/MME/answers/$CKPT/res_alldata.txt