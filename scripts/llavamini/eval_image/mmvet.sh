...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python $LLAVA_MINI_ROOT/llavamini/eval/model_vqa_loader.py \
        ...
        --question-file $DATA_ROOT/eval/mm-vet/llava-mm-vet.jsonl \
        --image-folder $DATA_ROOT/eval/mm-vet/images \
...
output_file=./playground/data/eval/mm-vet/answers/$CKPT.jsonl
...
python scripts/convert_mmvet_for_eval.py \
    --src $output_file \
    --dst ./playground/data/eval/mm-vet/answers/$CKPT.json
